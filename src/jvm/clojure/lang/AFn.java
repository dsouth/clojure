...
public abstract class AFn implements IFn {
    ...
    static public Object applyToHelper(IFn ifn, ISeq arglist) {
        switch (RT.boundedLength(arglist, 20)) {
            ...
            case 3:
                final Object first = arglist.first();
                arglist = arglist.next();
                final Object second = arglist.first();
                arglist = arglist.next();
                final Object third = Util.ret1(arglist.first(), arglist = null);
                return ifn.invoke(first, second, third);
            case 4:
                return ifn.invoke(arglist.first()
